...
export default function define(runtime, observer) {
  ...
  main.variable(observer("medium1")).define("medium1", ["d3","data","drag","invalidation"], _medium1);
  main.variable(observer("drag")).define("drag", ["d3"], _drag);
  main.variable(observer()).define(["md"], _6);
  main.variable(observer("medium2")).define("medium2", ["d3","data","drag","invalidation"], _medium2);
  main.variable(observer()).define(["md"], _8);
  main.variable(observer("medium3")).define("medium3", ["d3","data","drag","invalidation"], _medium3);
  return main;
}
